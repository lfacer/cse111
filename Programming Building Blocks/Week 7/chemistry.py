def make_periodic_table():
    ...
    #print('\n'.join(map(str, periodic_table_dict)))
...
def compute_molar_mass(symbol_quantity_list, periodic_table_dict):
    ...
    for i in symbol_quantity_list:
        ...
        element = small_symbol_quantity[SYMBOL_INDEX]
        quantity = small_symbol_quantity[QUANTITY_INDEX]
        element_list = periodic_table_dict[element][ATOMIC_MASS_INDEX]
        #atomic_mass = element_list[ATOMIC_MASS_INDEX]
        mass_element = element_list * quantity
...
def main():
    ...
    sample_mass = float(input("Please enter the mass of the chemical sample (g): "))
    ...
    #formula_name = parse_formula(formula, periodic_table_dict)
